 ...
 * @version $Id$
 */
public class OSXLionSidebarTreeModel extends AbstractLeopardLionSidebarTreeModel{
     ...
     */
    public OSXLionSidebarTreeModel(JFileChooser fileChooser, TreePath volumesPath, TreeModel model) {
